...
public class ContentCategoryController {
    ...
    @PatchMapping("/admin/content-categories/{id}/active")
    @PreAuthorize("hasAuthority('POST_MANAGE')")
    public ContentCategoryResponse setCategoryActive(@PathVariable Long id, @RequestParam boolean active) {
        return contentCategoryService.setCategoryActive(id, active);
    }

    @DeleteMapping("/admin/content-categories/{id}")
