...
public interface LabAchievementService {
    ...
    LabAchievementResponse getPublic(Long id);
    PublicLabAchievementDetailResponse getPublicDetail(Long id);
    ...
    List<LabAchievementFileResponse> listPublicFiles(Long achievementId);
