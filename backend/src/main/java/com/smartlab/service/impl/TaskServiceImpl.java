...
public class TaskServiceImpl implements TaskService {
    ...
    public TaskAttachmentResponse addAttachment(Long taskId, AddAttachmentRequest request, String currentEmail) {
        ...
        StoredFileEntity file = storedFileRepository.findById(request.getFileId())
    ...
    public TaskDetailResponse submitTask(Long taskId, SubmitTaskRequest request, String currentEmail) {
        ...
        // Submitter must be an assignee of this task
        ...
        if (!isAssignee && !isManager) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Only assignees or managers can submit this task");
        }
