...
class AuditLogPostgresIntegrationTest {
    ...
    private UserFixture insertUser(String tag) {
        ...
        Long id = jdbc.queryForObject("insert into tbl_user(user_id,name,email,password,is_active,is_account_verified,reset_otp_expire_at,created_at,updated_at) values(?,?,?,?,true,true,NULL,now(),now()) returning id",
